...
#[
  ...
  #url(r'^base/(?P<base_pk>\d+)/term/add/$', never_cache(taxadmin.term_add), name='term-add'),
  #url(r'^term/(?P<term_pk>\d+)/edit/$', never_cache(taxadmin.term_edit), name='term-edit'),
  #url(r'^term/(?P<pk>\d+)/delete/$', taxadmin.term_delete, name='term-delete'),
  ...
  #url(r'^base/add/$', never_cache(taxadmin.base_add), name='base-add'),
  #url(r'^base/(?P<base_pk>\d+)/edit/$', never_cache(taxadmin.base_edit), name='base-edit'),
  #url(r'^base/(?P<base_pk>\d+)/delete/$', taxadmin.base_delete, name='base-delete'),
  #url(r'^base/(?P<base_pk>\d+)/tosingleparent/$', taxadmin.base_to_singleparent, name='base-tosingleparent'),
